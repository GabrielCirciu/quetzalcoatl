...
public class CharacterNetworkedStats : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        InvokeRepeating(nameof(SendNetworkedCharacterData), 5.0f, 1.0f);
    }
    ...
    private void SendNetworkedCharacterData()
    {
        ...
        _dataString = DataIdentifier + _localSteamID + 
                      _localPlayerVector3.x.ToString("+0000.00;-0000.00") +
                      _localPlayerVector3.y.ToString("+0000.00;-0000.00") +
                      _localPlayerVector3.z.ToString("+0000.00;-0000.00");
    ...
    public void ReceiveNetworkedCharacterData(byte[] dataArray)
    {
        ...
        _receivedPlayerVector3.y = float.Parse(Encoding.UTF8.GetString(dataArray, 28, 8));
        _receivedPlayerVector3.z = float.Parse(Encoding.UTF8.GetString(dataArray, 36, 8));
        _clientDataManager.players[_receivedSteamID].character.transform.SetPositionAndRotation(_receivedPlayerVector3, Quaternion.identity);
